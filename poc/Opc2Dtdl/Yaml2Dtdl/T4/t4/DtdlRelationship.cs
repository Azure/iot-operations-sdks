...
namespace Yaml2Dtdl
{
    ...
    public partial class DtdlRelationship : DtdlRelationshipBase
    {
        /// <summary>
 ...
 if (this.relationshipDefinedType.Description != null && this.relationshipDefinedType.Description != string.Empty) { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(this.specMapper.GetUriFromSpecName(TypeConverter.GetSpecName(relationshipDefinedType))));
            this.Write("\"");
 ...
 if (this.Target != null) { 
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public class DtdlRelationshipBase
    {
        #region Fields
