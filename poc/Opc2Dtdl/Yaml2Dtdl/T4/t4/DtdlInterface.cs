...
namespace Yaml2Dtdl
{
    ...
    public partial class DtdlInterface : DtdlInterfaceBase
    {
        /// <summary>
 ...
 if (this.dtdlTelemetries.Count > 0 || this.dtdlProperties.Count > 0) { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(this.topicBase));
            this.Write("/{telemetryName}/{senderId}\",\r\n");
 } 
 ...
 foreach (DtdlRelationship dtdlRelationship in this.dtdlRelationships) { 
            this.Write(this.ToStringHelper.ToStringWithCulture(dtdlRelationship.TransformText()));
            this.Write(this.ToStringHelper.ToStringWithCulture(ix < this.contentCount ? "," : ""));
            this.Write("\r\n");
 ix++; } 
            this.Write("    ]\r\n  }");
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public class DtdlInterfaceBase
    {
        #region Fields
