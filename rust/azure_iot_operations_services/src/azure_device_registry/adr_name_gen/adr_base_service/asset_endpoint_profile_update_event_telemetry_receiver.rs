...
use super::asset_endpoint_profile_update_event_telemetry::AssetEndpointProfileUpdateEventTelemetry;

pub type AssetEndpointProfileUpdateEventTelemetryMessage =
    telemetry::receiver::Message<AssetEndpointProfileUpdateEventTelemetry>;

/// Telemetry Receiver for `AssetEndpointProfileUpdateEventTelemetry`
pub struct AssetEndpointProfileUpdateEventTelemetryReceiver<C>(
    telemetry::Receiver<AssetEndpointProfileUpdateEventTelemetry, C>,
)
where
    C: ManagedClient + Clone + Send + Sync + 'static,
    C::PubReceiver: Send + Sync + 'static;

impl<C> AssetEndpointProfileUpdateEventTelemetryReceiver<C>
where
    C: ManagedClient + Clone + Send + Sync + 'static,
    C::PubReceiver: Send + Sync + 'static,
{
    /// Creates a new [`AssetEndpointProfileUpdateEventTelemetryReceiver`]
    ///
    /// # Panics
    ...
    pub fn new(
        ...
        topic_token_map.insert(
            ...
            "assetEndpointProfileUpdateEvent".to_string(),
        );
    ...
    /// Shut down the [`AssetEndpointProfileUpdateEventTelemetryReceiver`]
    ///
    /// # Errors
    ...
    /// Receive the next [`AssetEndpointProfileUpdateEventTelemetryMessage`]
    ///
    /// # Errors
    ...
    pub async fn recv(
        ...
        Result<
            (
                AssetEndpointProfileUpdateEventTelemetryMessage,
                Option<AckToken>,
            ),
            AIOProtocolError,
        >,
