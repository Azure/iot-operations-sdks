...
use super::update_asset_endpoint_profile_status_request_payload::UpdateAssetEndpointProfileStatusRequestPayload;
use super::update_asset_endpoint_profile_status_response_payload::UpdateAssetEndpointProfileStatusResponsePayload;

pub type UpdateAssetEndpointProfileStatusRequest =
    rpc_command::invoker::Request<UpdateAssetEndpointProfileStatusRequestPayload>;
pub type UpdateAssetEndpointProfileStatusResponse =
    rpc_command::invoker::Response<UpdateAssetEndpointProfileStatusResponsePayload>;
pub type UpdateAssetEndpointProfileStatusRequestBuilderError =
    rpc_command::invoker::RequestBuilderError;

#[derive(Default)]
/// Builder for [`UpdateAssetEndpointProfileStatusRequest`]
pub struct UpdateAssetEndpointProfileStatusRequestBuilder {
    inner_builder:
        rpc_command::invoker::RequestBuilder<UpdateAssetEndpointProfileStatusRequestPayload>,
    topic_tokens: HashMap<String, String>,
}

impl UpdateAssetEndpointProfileStatusRequestBuilder {
    ...
    pub fn payload(
        &mut self,
        payload: UpdateAssetEndpointProfileStatusRequestPayload,
    ) -> Result<&mut Self, AIOProtocolError> {
        self.inner_builder.payload(payload)?;
        Ok(self)
    }

    /// Builds a new `UpdateAssetEndpointProfileStatusRequest`
    ///
    /// # Errors
    ...
    pub fn build(
        ...
        UpdateAssetEndpointProfileStatusRequest,
        UpdateAssetEndpointProfileStatusRequestBuilderError,
    > {
...
/// Command Invoker for `updateAssetEndpointProfileStatus`
pub struct UpdateAssetEndpointProfileStatusCommandInvoker<C>(
    rpc_command::Invoker<
        UpdateAssetEndpointProfileStatusRequestPayload,
        UpdateAssetEndpointProfileStatusResponsePayload,
        C,
    >,
)
where
...
impl<C> UpdateAssetEndpointProfileStatusCommandInvoker<C>
where
    C: ManagedClient + Clone + Send + Sync + 'static,
    C::PubReceiver: Send + Sync + 'static,
{
    /// Creates a new [`UpdateAssetEndpointProfileStatusCommandInvoker`]
    ///
    /// # Panics
    ...
    pub fn new(
        ...
        topic_token_map.insert(
            ...
            "updateAssetEndpointProfileStatus".to_string(),
        );

        let invoker_options = invoker_options_builder
            .request_topic_pattern(REQUEST_TOPIC_PATTERN)
            .command_name("updateAssetEndpointProfileStatus")
    ...
    /// Invokes the [`UpdateAssetEndpointProfileStatusRequest`]
    ///
    /// # Errors
    /// [`AIOProtocolError`] if there is a failure invoking the request
    pub async fn invoke(
        &self,
        request: UpdateAssetEndpointProfileStatusRequest,
    ) -> Result<UpdateAssetEndpointProfileStatusResponse, AIOProtocolError> {
        self.0.invoke(request).await
    }

    /// Shutdown the [`UpdateAssetEndpointProfileStatusCommandInvoker`]. Unsubscribes from the response topic and cancels the receiver loop to drop the receiver and to prevent the task from looping indefinitely.
    ///
