...
impl CreateOrUpdateDiscoveredDeviceCommandInvoker {
    ...
    pub fn new(
        ...
        let invoker_options = invoker_options_builder
            .request_topic_pattern("akri/discovery/resources/{ex:discoveryClientId}/{ex:inboundEndpointType}/createOrUpdateDiscoveredDevice")
                    ...
                    response.payload.create_or_update_discovered_device_error
                {
                    ...
                    Ok(Ok(CreateOrUpdateDiscoveredDeviceResponse {
                        payload: CreateOrUpdateDiscoveredDeviceResponsePayload {
                            discovered_device_response: response
                                .payload
                                .discovered_device_response
                                .ok_or(CreateOrUpdateDiscoveredDeviceCommandInvoker::get_err(
