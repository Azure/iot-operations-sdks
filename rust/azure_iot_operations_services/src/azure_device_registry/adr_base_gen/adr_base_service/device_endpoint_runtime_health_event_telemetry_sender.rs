...
use super::device_endpoint_runtime_health_event_telemetry::DeviceEndpointRuntimeHealthEventTelemetry;

pub type DeviceEndpointRuntimeHealthEventTelemetryMessage =
    telemetry::sender::Message<DeviceEndpointRuntimeHealthEventTelemetry>;
pub type DeviceEndpointRuntimeHealthEventTelemetryMessageBuilderError =
    telemetry::sender::MessageBuilderError;

/// Builder for [`DeviceEndpointRuntimeHealthEventTelemetryMessage`]
#[derive(Default)]
pub struct DeviceEndpointRuntimeHealthEventTelemetryMessageBuilder {
    inner_builder: telemetry::sender::MessageBuilder<DeviceEndpointRuntimeHealthEventTelemetry>,
    topic_tokens: HashMap<String, String>,
}

impl DeviceEndpointRuntimeHealthEventTelemetryMessageBuilder {
    ...
    pub fn payload(
        &mut self,
        payload: DeviceEndpointRuntimeHealthEventTelemetry,
    ) -> Result<&mut Self, AIOProtocolError> {
        self.inner_builder.payload(payload)?;
        Ok(self)
    }

    /// Builds a new `DeviceEndpointRuntimeHealthEventTelemetryMessage`
    ///
    /// # Errors
    ...
    pub fn build(
        ...
        DeviceEndpointRuntimeHealthEventTelemetryMessage,
        DeviceEndpointRuntimeHealthEventTelemetryMessageBuilderError,
    > {
...
/// Telemetry Sender for `DeviceEndpointRuntimeHealthEventTelemetry`
pub struct DeviceEndpointRuntimeHealthEventTelemetrySender(
    telemetry::Sender<DeviceEndpointRuntimeHealthEventTelemetry>,
);

impl DeviceEndpointRuntimeHealthEventTelemetrySender {
    /// Creates a new [`DeviceEndpointRuntimeHealthEventTelemetrySender`]
    ///
    /// # Panics
    ...
    pub fn new(
        ...
        let sender_options = sender_options_builder
            .topic_pattern("akri/connector/resources/telemetry/{ex:connectorClientId}/{ex:deviceName}/{ex:inboundEndpointName}/deviceEndpointRuntimeHealthEvent")
    ...
    /// Sends a [`DeviceEndpointRuntimeHealthEventTelemetryMessage`]
    ///
    /// # Error
    /// [`AIOProtocolError`] if there is a failure sending the message
    pub async fn send(
        &self,
        message: DeviceEndpointRuntimeHealthEventTelemetryMessage,
