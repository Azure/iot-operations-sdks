...
pub struct GetDeviceCommandInvoker(rpc_command::Invoker<EmptyJson, GetDeviceResponseSchema>);

impl GetDeviceCommandInvoker {
                    ...
                    Ok(Ok(GetDeviceResponse {
                        payload: GetDeviceResponsePayload {
                            device: response
                                .payload
                                .device
                                .ok_or(GetDeviceCommandInvoker::get_err("device"))?,
                        },
                        content_type: response.content_type,
                        format_indicator: response.format_indicator,
                        custom_user_data: response.custom_user_data,
