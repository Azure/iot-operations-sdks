...
pub struct GetAssetStatusCommandInvoker(
    rpc_command::Invoker<GetAssetStatusRequestPayload, GetAssetStatusResponseSchema>,
);

impl GetAssetStatusCommandInvoker {
                    ...
                    Ok(Ok(GetAssetStatusResponse {
                        payload: GetAssetStatusResponsePayload {
                            asset_status: response
                                .payload
                                .asset_status
                                .ok_or(GetAssetStatusCommandInvoker::get_err("assetStatus"))?,
                        },
                        content_type: response.content_type,
                        format_indicator: response.format_indicator,
                        custom_user_data: response.custom_user_data,
