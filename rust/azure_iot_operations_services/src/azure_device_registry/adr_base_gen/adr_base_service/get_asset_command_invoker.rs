...
pub struct GetAssetCommandInvoker(
    rpc_command::Invoker<GetAssetRequestPayload, GetAssetResponseSchema>,
);

impl GetAssetCommandInvoker {
                    ...
                    Ok(Ok(GetAssetResponse {
                        payload: GetAssetResponsePayload {
                            asset: response
                                .payload
                                .asset
                                .ok_or(GetAssetCommandInvoker::get_err("asset"))?,
                        },
                        content_type: response.content_type,
                        format_indicator: response.format_indicator,
                        custom_user_data: response.custom_user_data,
