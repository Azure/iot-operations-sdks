...
pub struct SetNotificationPreferenceForAssetUpdatesCommandInvoker(
    rpc_command::Invoker<
        SetNotificationPreferenceForAssetUpdatesRequestPayload,
                    ...
                    .set_notification_preference_for_asset_updates_error
                {
                    ...
                    Ok(Ok(SetNotificationPreferenceForAssetUpdatesResponse {
                        payload: SetNotificationPreferenceForAssetUpdatesResponsePayload {
                            response_payload: response.payload.response_payload.ok_or(
                                SetNotificationPreferenceForAssetUpdatesCommandInvoker::get_err(
                                    "responsePayload",
                                ),
                            )?,
                        },
