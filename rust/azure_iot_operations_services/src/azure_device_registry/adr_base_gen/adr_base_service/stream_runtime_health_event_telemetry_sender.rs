...
use super::stream_runtime_health_event_telemetry::StreamRuntimeHealthEventTelemetry;

pub type StreamRuntimeHealthEventTelemetryMessage =
    telemetry::sender::Message<StreamRuntimeHealthEventTelemetry>;
pub type StreamRuntimeHealthEventTelemetryMessageBuilderError =
    telemetry::sender::MessageBuilderError;

/// Builder for [`StreamRuntimeHealthEventTelemetryMessage`]
#[derive(Default)]
pub struct StreamRuntimeHealthEventTelemetryMessageBuilder {
    inner_builder: telemetry::sender::MessageBuilder<StreamRuntimeHealthEventTelemetry>,
    topic_tokens: HashMap<String, String>,
}

impl StreamRuntimeHealthEventTelemetryMessageBuilder {
    ...
    pub fn payload(
        &mut self,
        payload: StreamRuntimeHealthEventTelemetry,
    ) -> Result<&mut Self, AIOProtocolError> {
        self.inner_builder.payload(payload)?;
        Ok(self)
    }

    /// Builds a new `StreamRuntimeHealthEventTelemetryMessage`
    ///
    /// # Errors
    ...
    pub fn build(
        ...
        StreamRuntimeHealthEventTelemetryMessage,
        StreamRuntimeHealthEventTelemetryMessageBuilderError,
    > {
...
/// Telemetry Sender for `StreamRuntimeHealthEventTelemetry`
pub struct StreamRuntimeHealthEventTelemetrySender(
    telemetry::Sender<StreamRuntimeHealthEventTelemetry>,
);

impl StreamRuntimeHealthEventTelemetrySender {
    /// Creates a new [`StreamRuntimeHealthEventTelemetrySender`]
    ///
    /// # Panics
    ...
    pub fn new(
        ...
        let sender_options = sender_options_builder
            .topic_pattern("akri/connector/resources/telemetry/{ex:connectorClientId}/{ex:deviceName}/{ex:inboundEndpointName}/streamRuntimeHealthEvent")
    ...
    /// Sends a [`StreamRuntimeHealthEventTelemetryMessage`]
    ///
    /// # Error
    /// [`AIOProtocolError`] if there is a failure sending the message
    pub async fn send(
        &self,
        message: StreamRuntimeHealthEventTelemetryMessage,
