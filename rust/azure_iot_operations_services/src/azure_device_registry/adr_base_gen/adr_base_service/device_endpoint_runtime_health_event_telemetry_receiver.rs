...
pub type DeviceEndpointRuntimeHealthEventTelemetryMessage =
    telemetry::receiver::Message<DeviceEndpointRuntimeHealthEventTelemetry>;

/// Telemetry Receiver for `DeviceEndpointRuntimeHealthEventTelemetry`
pub struct DeviceEndpointRuntimeHealthEventTelemetryReceiver(
    telemetry::Receiver<DeviceEndpointRuntimeHealthEventTelemetry>,
);

impl DeviceEndpointRuntimeHealthEventTelemetryReceiver {
    /// Creates a new [`DeviceEndpointRuntimeHealthEventTelemetryReceiver`]
    ///
    /// # Panics
    ...
    /// Shut down the [`DeviceEndpointRuntimeHealthEventTelemetryReceiver`]
    ///
    /// # Errors
    ...
    /// Receive the next [`DeviceEndpointRuntimeHealthEventTelemetryMessage`]
    ///
    /// # Errors
