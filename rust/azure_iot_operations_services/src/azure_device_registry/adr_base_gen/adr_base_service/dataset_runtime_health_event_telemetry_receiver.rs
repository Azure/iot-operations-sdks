...
pub type DatasetRuntimeHealthEventTelemetryMessage =
    telemetry::receiver::Message<DatasetRuntimeHealthEventTelemetry>;

/// Telemetry Receiver for `DatasetRuntimeHealthEventTelemetry`
pub struct DatasetRuntimeHealthEventTelemetryReceiver(
    telemetry::Receiver<DatasetRuntimeHealthEventTelemetry>,
);

impl DatasetRuntimeHealthEventTelemetryReceiver {
    /// Creates a new [`DatasetRuntimeHealthEventTelemetryReceiver`]
    ///
    /// # Panics
    ...
    /// Shut down the [`DatasetRuntimeHealthEventTelemetryReceiver`]
    ///
    /// # Errors
    ...
    /// Receive the next [`DatasetRuntimeHealthEventTelemetryMessage`]
    ///
    /// # Errors
    ...
    pub async fn recv(
        ...
        Result<(DatasetRuntimeHealthEventTelemetryMessage, Option<AckToken>), AIOProtocolError>,
    > {
        self.0.recv().await
    }
}
