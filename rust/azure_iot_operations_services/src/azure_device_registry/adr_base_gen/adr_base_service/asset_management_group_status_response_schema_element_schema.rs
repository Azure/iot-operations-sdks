...
use super::asset_management_group_action_status_response_schema_element_schema::AssetManagementGroupActionStatusResponseSchemaElementSchema;

#[derive(Serialize, Deserialize, Debug, Clone, Builder)]
pub struct AssetManagementGroupStatusResponseSchemaElementSchema {
    /// Array of action statuses that describe the status of each action.
    #[serde(skip_serializing_if = "Option::is_none")]
    #[builder(default = "None")]
    pub actions: Option<Vec<AssetManagementGroupActionStatusResponseSchemaElementSchema>>,
