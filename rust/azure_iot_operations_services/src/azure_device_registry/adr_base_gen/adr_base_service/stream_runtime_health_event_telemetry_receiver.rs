...
pub type StreamRuntimeHealthEventTelemetryMessage =
    telemetry::receiver::Message<StreamRuntimeHealthEventTelemetry>;

/// Telemetry Receiver for `StreamRuntimeHealthEventTelemetry`
pub struct StreamRuntimeHealthEventTelemetryReceiver(
    telemetry::Receiver<StreamRuntimeHealthEventTelemetry>,
);

impl StreamRuntimeHealthEventTelemetryReceiver {
    /// Creates a new [`StreamRuntimeHealthEventTelemetryReceiver`]
    ///
    /// # Panics
    ...
    /// Shut down the [`StreamRuntimeHealthEventTelemetryReceiver`]
    ///
    /// # Errors
    ...
    /// Receive the next [`StreamRuntimeHealthEventTelemetryMessage`]
    ///
    /// # Errors
    ...
    pub async fn recv(
        ...
        Result<(StreamRuntimeHealthEventTelemetryMessage, Option<AckToken>), AIOProtocolError>,
    > {
        self.0.recv().await
    }
}
