...
pub struct CreateOrUpdateDiscoveredAssetCommandInvoker(
    rpc_command::Invoker<
...
impl CreateOrUpdateDiscoveredAssetCommandInvoker {
                    ...
                    response.payload.create_or_update_discovered_asset_error
                {
                    ...
                    Ok(Ok(CreateOrUpdateDiscoveredAssetResponse {
                        payload: CreateOrUpdateDiscoveredAssetResponsePayload {
                            discovered_asset_response: response
                                .payload
                                .discovered_asset_response
                                .ok_or(
                                CreateOrUpdateDiscoveredAssetCommandInvoker::get_err(
