...
pub type ManagementActionRuntimeHealthEventTelemetryMessage =
    telemetry::sender::Message<ManagementActionRuntimeHealthEventTelemetry>;
pub type ManagementActionRuntimeHealthEventTelemetryMessageBuilderError =
    telemetry::sender::MessageBuilderError;

/// Builder for [`ManagementActionRuntimeHealthEventTelemetryMessage`]
#[derive(Default)]
pub struct ManagementActionRuntimeHealthEventTelemetryMessageBuilder {
    inner_builder: telemetry::sender::MessageBuilder<ManagementActionRuntimeHealthEventTelemetry>,
    topic_tokens: HashMap<String, String>,
}

impl ManagementActionRuntimeHealthEventTelemetryMessageBuilder {
    ...
    pub fn payload(
        &mut self,
        payload: ManagementActionRuntimeHealthEventTelemetry,
    ) -> Result<&mut Self, AIOProtocolError> {
        self.inner_builder.payload(payload)?;
        Ok(self)
    }

    /// Builds a new `ManagementActionRuntimeHealthEventTelemetryMessage`
    ///
    /// # Errors
    ...
    pub fn build(
        ...
        ManagementActionRuntimeHealthEventTelemetryMessageBuilderError,
    > {
...
/// Telemetry Sender for `ManagementActionRuntimeHealthEventTelemetry`
pub struct ManagementActionRuntimeHealthEventTelemetrySender(
    telemetry::Sender<ManagementActionRuntimeHealthEventTelemetry>,
);

impl ManagementActionRuntimeHealthEventTelemetrySender {
    /// Creates a new [`ManagementActionRuntimeHealthEventTelemetrySender`]
    ///
    /// # Panics
    ...
    pub fn new(
        ...
        let sender_options = sender_options_builder
            .topic_pattern("akri/connector/resources/telemetry/{ex:connectorClientId}/{ex:deviceName}/{ex:inboundEndpointName}/managementActionRuntimeHealthEvent")
    ...
    /// Sends a [`ManagementActionRuntimeHealthEventTelemetryMessage`]
    ///
    /// # Error
    /// [`AIOProtocolError`] if there is a failure sending the message
    pub async fn send(
        &self,
        message: ManagementActionRuntimeHealthEventTelemetryMessage,
