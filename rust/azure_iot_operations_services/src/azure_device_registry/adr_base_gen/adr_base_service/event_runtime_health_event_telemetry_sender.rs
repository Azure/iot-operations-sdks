...
pub type EventRuntimeHealthEventTelemetryMessage =
    telemetry::sender::Message<EventRuntimeHealthEventTelemetry>;
pub type EventRuntimeHealthEventTelemetryMessageBuilderError =
    telemetry::sender::MessageBuilderError;

/// Builder for [`EventRuntimeHealthEventTelemetryMessage`]
#[derive(Default)]
pub struct EventRuntimeHealthEventTelemetryMessageBuilder {
    inner_builder: telemetry::sender::MessageBuilder<EventRuntimeHealthEventTelemetry>,
    topic_tokens: HashMap<String, String>,
}

impl EventRuntimeHealthEventTelemetryMessageBuilder {
    ...
    pub fn payload(
        &mut self,
        payload: EventRuntimeHealthEventTelemetry,
    ) -> Result<&mut Self, AIOProtocolError> {
        self.inner_builder.payload(payload)?;
        Ok(self)
    }

    /// Builds a new `EventRuntimeHealthEventTelemetryMessage`
    ///
    /// # Errors
    ...
    pub fn build(
        ...
        EventRuntimeHealthEventTelemetryMessage,
        EventRuntimeHealthEventTelemetryMessageBuilderError,
    > {
...
/// Telemetry Sender for `EventRuntimeHealthEventTelemetry`
pub struct EventRuntimeHealthEventTelemetrySender(
    telemetry::Sender<EventRuntimeHealthEventTelemetry>,
);

impl EventRuntimeHealthEventTelemetrySender {
    /// Creates a new [`EventRuntimeHealthEventTelemetrySender`]
    ///
    /// # Panics
    ...
    pub fn new(
        ...
        let sender_options = sender_options_builder
            .topic_pattern("akri/connector/resources/telemetry/{ex:connectorClientId}/{ex:deviceName}/{ex:inboundEndpointName}/eventRuntimeHealthEvent")
    ...
    /// Sends a [`EventRuntimeHealthEventTelemetryMessage`]
    ///
    /// # Error
    /// [`AIOProtocolError`] if there is a failure sending the message
    pub async fn send(
        &self,
        message: EventRuntimeHealthEventTelemetryMessage,
