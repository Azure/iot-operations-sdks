...
mod asset_status_event_group;
mod asset_status_management_group;
mod asset_status_management_group_action;
...
pub mod client {
    ...
    pub use super::asset_status_event_group::*;
    pub use super::asset_status_management_group::*;
    pub use super::asset_status_management_group_action::*;
