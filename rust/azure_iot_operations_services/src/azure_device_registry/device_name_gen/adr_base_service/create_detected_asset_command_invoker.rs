...
pub type CreateDetectedAssetRequest = rpc_command::invoker::Request<CreateDetectedAssetRequestPayload>;
pub type CreateDetectedAssetResponse = rpc_command::invoker::Response<CreateDetectedAssetResponsePayload>;
...
impl CreateDetectedAssetRequestBuilder {
    ...
    pub fn build(&mut self) -> Result<CreateDetectedAssetRequest, CreateDetectedAssetRequestBuilderError> {
