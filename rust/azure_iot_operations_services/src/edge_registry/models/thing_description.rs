...
#[derive(Debug, Clone)]
pub struct ThingDescriptionVersionEntity {
    /// Version identifier.
    pub version_id: u64,
    /// Resource identifier.
...
impl From<client_gen::ThingDescriptionVersion> for ThingDescriptionVersionEntity {
    fn from(value: client_gen::ThingDescriptionVersion) -> Self {
        ThingDescriptionVersionEntity {
...
impl From<client_gen::ThingDescriptionVersionXid> for VersionXId<u64> {
...
impl From<client_gen::ThingDescriptionVersionXidList> for Vec<VersionXId<u64>> {
    fn from(value: client_gen::ThingDescriptionVersionXidList) -> Self {
        value.versions.into_iter().map(Into::into).collect()
    }
}

/// Format of a Thing Description Version document.
///
