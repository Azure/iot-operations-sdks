...
use super::get_thing_description_input_arguments::GetThingDescriptionInputArguments;
use super::get_thing_description_output_arguments::GetThingDescriptionOutputArguments;
use super::get_thing_description_response_schema::GetThingDescriptionResponseSchema;
use super::thing_description_extension_error::ThingDescriptionExtensionError;

pub type GetThingDescriptionRequest =
    rpc_command::invoker::Request<GetThingDescriptionInputArguments>;
pub type GetThingDescriptionResponse =
    rpc_command::invoker::Response<GetThingDescriptionOutputArguments>;
pub type GetThingDescriptionResponseError =
    rpc_command::invoker::Response<ThingDescriptionExtensionError>;
pub type GetThingDescriptionRequestBuilderError = rpc_command::invoker::RequestBuilderError;

#[derive(Default)]
/// Builder for [`GetThingDescriptionRequest`]
pub struct GetThingDescriptionRequestBuilder {
    inner_builder: rpc_command::invoker::RequestBuilder<GetThingDescriptionInputArguments>,
    topic_tokens: HashMap<String, String>,
}

impl GetThingDescriptionRequestBuilder {
    ...
    pub fn payload(
        &mut self,
        payload: GetThingDescriptionInputArguments,
    ) -> Result<&mut Self, AIOProtocolError> {
        self.inner_builder.payload(payload)?;
        Ok(self)
    }

    /// Builds a new `GetThingDescriptionRequest`
    ///
    /// # Errors
    ...
    pub fn build(
        &mut self,
    ) -> Result<GetThingDescriptionRequest, GetThingDescriptionRequestBuilderError> {
...
/// Command Invoker for `getThingDescription`
pub struct GetThingDescriptionActionInvoker(
    rpc_command::Invoker<GetThingDescriptionInputArguments, GetThingDescriptionResponseSchema>,
);

impl GetThingDescriptionActionInvoker {
    /// Creates a new [`GetThingDescriptionActionInvoker`]
    ///
    /// # Panics
    ...
    pub fn new(
        ...
        let invoker_options = invoker_options_builder
            .request_topic_pattern("adr/dtmi:ms:adr:EdgeRegistry;1/get/thingdescription")
            .command_name("getThingDescription")
    ...
    /// Invokes the [`GetThingDescriptionRequest`]
    ///
    /// # Errors
    /// [`AIOProtocolError`] if there is a failure invoking the request
    pub async fn invoke(
        &self,
        request: GetThingDescriptionRequest,
    ) -> Result<
        Result<GetThingDescriptionResponse, GetThingDescriptionResponseError>,
        AIOProtocolError,
    > {
        ...
        match response {
            Ok(response) => {
                if let Some(error) = response.payload.error {
                    Ok(Err(GetThingDescriptionResponseError {
                        payload: error,
                    ...
                    Ok(Ok(GetThingDescriptionResponse {
                        payload: response
                            .payload
                            .output
                            .ok_or(GetThingDescriptionActionInvoker::get_err("_output"))?,
                        content_type: response.content_type,
                        format_indicator: response.format_indicator,
                        custom_user_data: response.custom_user_data,
                        timestamp: response.timestamp,
    ...
    /// Shutdown the [`GetThingDescriptionActionInvoker`]. Unsubscribes from the response topic and cancels the receiver loop to drop the receiver and to prevent the task from looping indefinitely.
    ///
    ...
    fn get_err(field_name: &str) -> AIOProtocolError {
        AIOProtocolError {
            ...
            property_name: None,
            property_value: None,
            command_name: Some("getThingDescription".to_string()),
