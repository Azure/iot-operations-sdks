...
use super::create_thing_description_input_arguments::CreateThingDescriptionInputArguments;
use super::create_thing_description_output_arguments::CreateThingDescriptionOutputArguments;
use super::create_thing_description_response_schema::CreateThingDescriptionResponseSchema;
use super::thing_description_extension_error::ThingDescriptionExtensionError;

pub type CreateThingDescriptionRequest =
    rpc_command::invoker::Request<CreateThingDescriptionInputArguments>;
pub type CreateThingDescriptionResponse =
    rpc_command::invoker::Response<CreateThingDescriptionOutputArguments>;
pub type CreateThingDescriptionResponseError =
    rpc_command::invoker::Response<ThingDescriptionExtensionError>;
pub type CreateThingDescriptionRequestBuilderError = rpc_command::invoker::RequestBuilderError;

#[derive(Default)]
/// Builder for [`CreateThingDescriptionRequest`]
pub struct CreateThingDescriptionRequestBuilder {
    inner_builder: rpc_command::invoker::RequestBuilder<CreateThingDescriptionInputArguments>,
    topic_tokens: HashMap<String, String>,
}

impl CreateThingDescriptionRequestBuilder {
    ...
    pub fn payload(
        &mut self,
        payload: CreateThingDescriptionInputArguments,
    ) -> Result<&mut Self, AIOProtocolError> {
        self.inner_builder.payload(payload)?;
        Ok(self)
    }

    /// Builds a new `CreateThingDescriptionRequest`
    ///
    /// # Errors
    ...
    pub fn build(
        &mut self,
    ) -> Result<CreateThingDescriptionRequest, CreateThingDescriptionRequestBuilderError> {
...
/// Command Invoker for `createThingDescription`
pub struct CreateThingDescriptionActionInvoker(
    rpc_command::Invoker<
        CreateThingDescriptionInputArguments,
        CreateThingDescriptionResponseSchema,
    >,
);

impl CreateThingDescriptionActionInvoker {
    /// Creates a new [`CreateThingDescriptionActionInvoker`]
    ///
    /// # Panics
    ...
    pub fn new(
        ...
        let invoker_options = invoker_options_builder
            .request_topic_pattern("adr/dtmi:ms:adr:EdgeRegistry;1/create/thingdescription")
            .command_name("createThingDescription")
    ...
    /// Invokes the [`CreateThingDescriptionRequest`]
    ///
    /// # Errors
    /// [`AIOProtocolError`] if there is a failure invoking the request
    pub async fn invoke(
        &self,
        request: CreateThingDescriptionRequest,
    ) -> Result<
        Result<CreateThingDescriptionResponse, CreateThingDescriptionResponseError>,
        AIOProtocolError,
    > {
        ...
        match response {
            Ok(response) => {
                if let Some(error) = response.payload.error {
                    Ok(Err(CreateThingDescriptionResponseError {
                        payload: error,
                    ...
                    Ok(Ok(CreateThingDescriptionResponse {
                        payload: response
                            .payload
                            .output
                            .ok_or(CreateThingDescriptionActionInvoker::get_err("_output"))?,
                        content_type: response.content_type,
                        format_indicator: response.format_indicator,
                        custom_user_data: response.custom_user_data,
                        timestamp: response.timestamp,
    ...
    /// Shutdown the [`CreateThingDescriptionActionInvoker`]. Unsubscribes from the response topic and cancels the receiver loop to drop the receiver and to prevent the task from looping indefinitely.
    ///
    ...
    fn get_err(field_name: &str) -> AIOProtocolError {
        AIOProtocolError {
            ...
            property_name: None,
            property_value: None,
            command_name: Some("createThingDescription".to_string()),
