...
use super::create_or_get_thing_description_version_input_arguments::CreateOrGetThingDescriptionVersionInputArguments;
use super::create_or_get_thing_description_version_output_arguments::CreateOrGetThingDescriptionVersionOutputArguments;
use super::create_or_get_thing_description_version_response_schema::CreateOrGetThingDescriptionVersionResponseSchema;
use super::thing_description_extension_error::ThingDescriptionExtensionError;

pub type CreateOrGetThingDescriptionVersionRequest =
    rpc_command::invoker::Request<CreateOrGetThingDescriptionVersionInputArguments>;
pub type CreateOrGetThingDescriptionVersionResponse =
    rpc_command::invoker::Response<CreateOrGetThingDescriptionVersionOutputArguments>;
pub type CreateOrGetThingDescriptionVersionResponseError =
    rpc_command::invoker::Response<ThingDescriptionExtensionError>;
pub type CreateOrGetThingDescriptionVersionRequestBuilderError =
    rpc_command::invoker::RequestBuilderError;

#[derive(Default)]
/// Builder for [`CreateOrGetThingDescriptionVersionRequest`]
pub struct CreateOrGetThingDescriptionVersionRequestBuilder {
    inner_builder:
        rpc_command::invoker::RequestBuilder<CreateOrGetThingDescriptionVersionInputArguments>,
    topic_tokens: HashMap<String, String>,
}

impl CreateOrGetThingDescriptionVersionRequestBuilder {
    ...
    pub fn payload(
        &mut self,
        payload: CreateOrGetThingDescriptionVersionInputArguments,
    ) -> Result<&mut Self, AIOProtocolError> {
        self.inner_builder.payload(payload)?;
        Ok(self)
    }

    /// Builds a new `CreateOrGetThingDescriptionVersionRequest`
    ///
    /// # Errors
    ...
    pub fn build(
        ...
        CreateOrGetThingDescriptionVersionRequest,
        CreateOrGetThingDescriptionVersionRequestBuilderError,
    > {
...
/// Command Invoker for `createOrGetThingDescriptionVersion`
pub struct CreateOrGetThingDescriptionVersionActionInvoker(
    rpc_command::Invoker<
        CreateOrGetThingDescriptionVersionInputArguments,
        CreateOrGetThingDescriptionVersionResponseSchema,
    >,
);

impl CreateOrGetThingDescriptionVersionActionInvoker {
    /// Creates a new [`CreateOrGetThingDescriptionVersionActionInvoker`]
    ///
    /// # Panics
    ...
    pub fn new(
        ...
        let invoker_options = invoker_options_builder
            .request_topic_pattern("aio/registry/thingDescriptionExtension/createOrGet/thingdescriptiongroups/thingdescriptions/{ex:thingDescriptionId}/versions/{ex:versionId}")
    ...
    /// Invokes the [`CreateOrGetThingDescriptionVersionRequest`]
    ///
    /// # Errors
    /// [`AIOProtocolError`] if there is a failure invoking the request
    pub async fn invoke(
        &self,
        request: CreateOrGetThingDescriptionVersionRequest,
    ) -> Result<
        Result<
            CreateOrGetThingDescriptionVersionResponse,
            CreateOrGetThingDescriptionVersionResponseError,
        >,
        AIOProtocolError,
    > {
        ...
        match response {
            Ok(response) => {
                if let Some(error) = response.payload.error {
                    Ok(Err(CreateOrGetThingDescriptionVersionResponseError {
                        payload: error,
                    ...
                    Ok(Ok(CreateOrGetThingDescriptionVersionResponse {
                        payload: response.payload.output.ok_or(
                            CreateOrGetThingDescriptionVersionActionInvoker::get_err("_output"),
                        )?,
                        content_type: response.content_type,
                        format_indicator: response.format_indicator,
                        custom_user_data: response.custom_user_data,
    ...
    /// Shutdown the [`CreateOrGetThingDescriptionVersionActionInvoker`]. Unsubscribes from the response topic and cancels the receiver loop to drop the receiver and to prevent the task from looping indefinitely.
    ///
    ...
    fn get_err(field_name: &str) -> AIOProtocolError {
        AIOProtocolError {
            ...
            property_name: None,
            property_value: None,
            command_name: Some("createOrGetThingDescriptionVersion".to_string()),
