...
use super::create_or_get_schema_version_input_arguments::CreateOrGetSchemaVersionInputArguments;
use super::create_or_get_schema_version_output_arguments::CreateOrGetSchemaVersionOutputArguments;
use super::create_or_get_schema_version_response_schema::CreateOrGetSchemaVersionResponseSchema;
use super::schema_extension_error::SchemaExtensionError;

pub type CreateOrGetSchemaVersionRequest =
    rpc_command::invoker::Request<CreateOrGetSchemaVersionInputArguments>;
pub type CreateOrGetSchemaVersionResponse =
    rpc_command::invoker::Response<CreateOrGetSchemaVersionOutputArguments>;
pub type CreateOrGetSchemaVersionResponseError =
    rpc_command::invoker::Response<SchemaExtensionError>;
pub type CreateOrGetSchemaVersionRequestBuilderError = rpc_command::invoker::RequestBuilderError;

#[derive(Default)]
/// Builder for [`CreateOrGetSchemaVersionRequest`]
pub struct CreateOrGetSchemaVersionRequestBuilder {
    inner_builder: rpc_command::invoker::RequestBuilder<CreateOrGetSchemaVersionInputArguments>,
    topic_tokens: HashMap<String, String>,
}

impl CreateOrGetSchemaVersionRequestBuilder {
    ...
    pub fn payload(
        &mut self,
        payload: CreateOrGetSchemaVersionInputArguments,
    ) -> Result<&mut Self, AIOProtocolError> {
        self.inner_builder.payload(payload)?;
        Ok(self)
    }

    /// Builds a new `CreateOrGetSchemaVersionRequest`
    ///
    /// # Errors
    ...
    pub fn build(
        &mut self,
    ) -> Result<CreateOrGetSchemaVersionRequest, CreateOrGetSchemaVersionRequestBuilderError> {
...
/// Command Invoker for `createOrGetSchemaVersion`
pub struct CreateOrGetSchemaVersionActionInvoker(
    rpc_command::Invoker<
        CreateOrGetSchemaVersionInputArguments,
        CreateOrGetSchemaVersionResponseSchema,
    >,
);

impl CreateOrGetSchemaVersionActionInvoker {
    /// Creates a new [`CreateOrGetSchemaVersionActionInvoker`]
    ///
    /// # Panics
    ...
    pub fn new(
        ...
        let invoker_options = invoker_options_builder
            .request_topic_pattern("aio/registry/schemaExtension/createOrGet/schemagroups/schemas/{ex:schemaId}/versions/version")
    ...
    /// Invokes the [`CreateOrGetSchemaVersionRequest`]
    ///
    /// # Errors
    /// [`AIOProtocolError`] if there is a failure invoking the request
    pub async fn invoke(
        &self,
        request: CreateOrGetSchemaVersionRequest,
    ) -> Result<
        Result<CreateOrGetSchemaVersionResponse, CreateOrGetSchemaVersionResponseError>,
        AIOProtocolError,
    > {
        ...
        match response {
            Ok(response) => {
                if let Some(error) = response.payload.error {
                    Ok(Err(CreateOrGetSchemaVersionResponseError {
                        payload: error,
                    ...
                    Ok(Ok(CreateOrGetSchemaVersionResponse {
                        payload: response
                            .payload
                            .output
                            .ok_or(CreateOrGetSchemaVersionActionInvoker::get_err("_output"))?,
                        content_type: response.content_type,
                        format_indicator: response.format_indicator,
                        custom_user_data: response.custom_user_data,
                        timestamp: response.timestamp,
    ...
    /// Shutdown the [`CreateOrGetSchemaVersionActionInvoker`]. Unsubscribes from the response topic and cancels the receiver loop to drop the receiver and to prevent the task from looping indefinitely.
    ///
    ...
    fn get_err(field_name: &str) -> AIOProtocolError {
        AIOProtocolError {
            ...
            property_name: None,
            property_value: None,
            command_name: Some("createOrGetSchemaVersion".to_string()),
