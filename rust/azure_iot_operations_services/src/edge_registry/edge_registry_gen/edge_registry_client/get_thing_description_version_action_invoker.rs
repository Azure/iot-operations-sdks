...
use super::get_thing_description_version_input_arguments::GetThingDescriptionVersionInputArguments;
use super::get_thing_description_version_output_arguments::GetThingDescriptionVersionOutputArguments;
use super::get_thing_description_version_response_schema::GetThingDescriptionVersionResponseSchema;
use super::thing_description_extension_error::ThingDescriptionExtensionError;

pub type GetThingDescriptionVersionRequest =
    rpc_command::invoker::Request<GetThingDescriptionVersionInputArguments>;
pub type GetThingDescriptionVersionResponse =
    rpc_command::invoker::Response<GetThingDescriptionVersionOutputArguments>;
pub type GetThingDescriptionVersionResponseError =
    rpc_command::invoker::Response<ThingDescriptionExtensionError>;
pub type GetThingDescriptionVersionRequestBuilderError = rpc_command::invoker::RequestBuilderError;

#[derive(Default)]
/// Builder for [`GetThingDescriptionVersionRequest`]
pub struct GetThingDescriptionVersionRequestBuilder {
    inner_builder: rpc_command::invoker::RequestBuilder<GetThingDescriptionVersionInputArguments>,
    topic_tokens: HashMap<String, String>,
}

impl GetThingDescriptionVersionRequestBuilder {
    ...
    pub fn payload(
        &mut self,
        payload: GetThingDescriptionVersionInputArguments,
    ) -> Result<&mut Self, AIOProtocolError> {
        self.inner_builder.payload(payload)?;
        Ok(self)
    }

    /// Builds a new `GetThingDescriptionVersionRequest`
    ///
    /// # Errors
    ...
    pub fn build(
        &mut self,
    ) -> Result<GetThingDescriptionVersionRequest, GetThingDescriptionVersionRequestBuilderError>
    {
...
/// Command Invoker for `getThingDescriptionVersion`
pub struct GetThingDescriptionVersionActionInvoker(
    rpc_command::Invoker<
...
impl GetThingDescriptionVersionActionInvoker {
    /// Creates a new [`GetThingDescriptionVersionActionInvoker`]
    ///
    /// # Panics
    ...
    /// Invokes the [`GetThingDescriptionVersionRequest`]
    ///
    /// # Errors
    /// [`AIOProtocolError`] if there is a failure invoking the request
    pub async fn invoke(
        &self,
        request: GetThingDescriptionVersionRequest,
    ) -> Result<
        Result<GetThingDescriptionVersionResponse, GetThingDescriptionVersionResponseError>,
        AIOProtocolError,
    > {
        ...
        match response {
            Ok(response) => {
                if let Some(error) = response.payload.error {
                    Ok(Err(GetThingDescriptionVersionResponseError {
                        payload: error,
                    ...
                    Ok(Ok(GetThingDescriptionVersionResponse {
                        payload: response
                            .payload
                            .output
                            .ok_or(GetThingDescriptionVersionActionInvoker::get_err("_output"))?,
                        content_type: response.content_type,
                        format_indicator: response.format_indicator,
                        custom_user_data: response.custom_user_data,
                        timestamp: response.timestamp,
    ...
    /// Shutdown the [`GetThingDescriptionVersionActionInvoker`]. Unsubscribes from the response topic and cancels the receiver loop to drop the receiver and to prevent the task from looping indefinitely.
    ///
    ...
    fn get_err(field_name: &str) -> AIOProtocolError {
        AIOProtocolError {
            ...
            property_name: None,
            property_value: None,
            command_name: Some("getThingDescriptionVersion".to_string()),
