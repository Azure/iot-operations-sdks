...
use super::list_thing_description_versions_output_arguments::ListThingDescriptionVersionsOutputArguments;
use super::list_thing_description_versions_response_schema::ListThingDescriptionVersionsResponseSchema;
use super::thing_description_extension_error::ThingDescriptionExtensionError;

pub type ListThingDescriptionVersionsRequest =
    rpc_command::invoker::Request<ListThingDescriptionVersionsInputArguments>;
pub type ListThingDescriptionVersionsResponse =
    rpc_command::invoker::Response<ListThingDescriptionVersionsOutputArguments>;
pub type ListThingDescriptionVersionsResponseError =
    rpc_command::invoker::Response<ThingDescriptionExtensionError>;
pub type ListThingDescriptionVersionsRequestBuilderError =
    rpc_command::invoker::RequestBuilderError;

#[derive(Default)]
/// Builder for [`ListThingDescriptionVersionsRequest`]
pub struct ListThingDescriptionVersionsRequestBuilder {
    inner_builder: rpc_command::invoker::RequestBuilder<ListThingDescriptionVersionsInputArguments>,
    topic_tokens: HashMap<String, String>,
}

impl ListThingDescriptionVersionsRequestBuilder {
    ...
    pub fn payload(
        &mut self,
        payload: ListThingDescriptionVersionsInputArguments,
    ) -> Result<&mut Self, AIOProtocolError> {
        self.inner_builder.payload(payload)?;
        Ok(self)
    }

    /// Builds a new `ListThingDescriptionVersionsRequest`
    ///
    /// # Errors
    ...
    pub fn build(
        &mut self,
    ) -> Result<ListThingDescriptionVersionsRequest, ListThingDescriptionVersionsRequestBuilderError>
    {
...
/// Command Invoker for `listThingDescriptionVersions`
pub struct ListThingDescriptionVersionsActionInvoker(
    rpc_command::Invoker<
...
impl ListThingDescriptionVersionsActionInvoker {
    /// Creates a new [`ListThingDescriptionVersionsActionInvoker`]
    ///
    /// # Panics
    ...
    pub fn new(
        ...
        let invoker_options = invoker_options_builder
            .request_topic_pattern("aio/registry/thingDescriptionExtension/list/thingdescriptiongroups/thingdescriptions/{ex:thingDescriptionId}/versions")
            .command_name("listThingDescriptionVersions")
    ...
    /// Invokes the [`ListThingDescriptionVersionsRequest`]
    ///
    /// # Errors
    /// [`AIOProtocolError`] if there is a failure invoking the request
    pub async fn invoke(
        &self,
        request: ListThingDescriptionVersionsRequest,
    ) -> Result<
        Result<ListThingDescriptionVersionsResponse, ListThingDescriptionVersionsResponseError>,
        AIOProtocolError,
    > {
        ...
        match response {
            Ok(response) => {
                if let Some(error) = response.payload.error {
                    Ok(Err(ListThingDescriptionVersionsResponseError {
                        payload: error,
                    ...
                    Ok(Ok(ListThingDescriptionVersionsResponse {
                        payload: ListThingDescriptionVersionsOutputArguments {
                            ids: response
                                .payload
                                .ids
                                .ok_or(ListThingDescriptionVersionsActionInvoker::get_err("ids"))?,
                        },
                        content_type: response.content_type,
                        format_indicator: response.format_indicator,
                        custom_user_data: response.custom_user_data,
    ...
    /// Shutdown the [`ListThingDescriptionVersionsActionInvoker`]. Unsubscribes from the response topic and cancels the receiver loop to drop the receiver and to prevent the task from looping indefinitely.
    ///
    ...
    fn get_err(field_name: &str) -> AIOProtocolError {
        AIOProtocolError {
            ...
            property_name: None,
            property_value: None,
            command_name: Some("listThingDescriptionVersions".to_string()),
