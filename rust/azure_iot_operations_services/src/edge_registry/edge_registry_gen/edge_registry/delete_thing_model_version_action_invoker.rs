...
use super::delete_thing_model_version_output_arguments::DeleteThingModelVersionOutputArguments;
use super::delete_thing_model_version_response_schema::DeleteThingModelVersionResponseSchema;
use super::thing_model_extension_error::ThingModelExtensionError;

pub type DeleteThingModelVersionRequest =
    rpc_command::invoker::Request<DeleteThingModelVersionInputArguments>;
pub type DeleteThingModelVersionResponse =
    rpc_command::invoker::Response<DeleteThingModelVersionOutputArguments>;
pub type DeleteThingModelVersionResponseError =
    rpc_command::invoker::Response<ThingModelExtensionError>;
pub type DeleteThingModelVersionRequestBuilderError = rpc_command::invoker::RequestBuilderError;

#[derive(Default)]
/// Builder for [`DeleteThingModelVersionRequest`]
pub struct DeleteThingModelVersionRequestBuilder {
    inner_builder: rpc_command::invoker::RequestBuilder<DeleteThingModelVersionInputArguments>,
    topic_tokens: HashMap<String, String>,
}

impl DeleteThingModelVersionRequestBuilder {
    ...
    pub fn payload(
        &mut self,
        payload: DeleteThingModelVersionInputArguments,
    ) -> Result<&mut Self, AIOProtocolError> {
        self.inner_builder.payload(payload)?;
        Ok(self)
    }

    /// Builds a new `DeleteThingModelVersionRequest`
    ///
    /// # Errors
    ...
    pub fn build(
        &mut self,
    ) -> Result<DeleteThingModelVersionRequest, DeleteThingModelVersionRequestBuilderError> {
...
/// Command Invoker for `deleteThingModelVersion`
pub struct DeleteThingModelVersionActionInvoker(
    rpc_command::Invoker<
        DeleteThingModelVersionInputArguments,
        DeleteThingModelVersionResponseSchema,
    >,
);

impl DeleteThingModelVersionActionInvoker {
    /// Creates a new [`DeleteThingModelVersionActionInvoker`]
    ///
    /// # Panics
    ...
    pub fn new(
        ...
        let invoker_options = invoker_options_builder
            .request_topic_pattern("aio/registry/thingModelExtension/delete/thingmodelgroups/thingmodels/{ex:thingModelId}/versions/{ex:versionId}")
            .command_name("deleteThingModelVersion")
    ...
    /// Invokes the [`DeleteThingModelVersionRequest`]
    ///
    /// # Errors
    /// [`AIOProtocolError`] if there is a failure invoking the request
    pub async fn invoke(
        &self,
        request: DeleteThingModelVersionRequest,
    ) -> Result<
        Result<DeleteThingModelVersionResponse, DeleteThingModelVersionResponseError>,
        AIOProtocolError,
    > {
        ...
        match response {
            Ok(response) => {
                if let Some(error) = response.payload.error {
                    Ok(Err(DeleteThingModelVersionResponseError {
                        payload: error,
    ...
    /// Shutdown the [`DeleteThingModelVersionActionInvoker`]. Unsubscribes from the response topic and cancels the receiver loop to drop the receiver and to prevent the task from looping indefinitely.
    ///
    ...
    fn get_err(field_name: &str) -> AIOProtocolError {
        AIOProtocolError {
            ...
            property_name: None,
            property_value: None,
            command_name: Some("deleteThingModelVersion".to_string()),
