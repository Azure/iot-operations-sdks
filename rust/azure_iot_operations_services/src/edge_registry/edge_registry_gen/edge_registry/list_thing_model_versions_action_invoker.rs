...
use super::list_thing_model_versions_input_arguments::ListThingModelVersionsInputArguments;
use super::list_thing_model_versions_output_arguments::ListThingModelVersionsOutputArguments;
use super::list_thing_model_versions_response_schema::ListThingModelVersionsResponseSchema;
use super::thing_model_extension_error::ThingModelExtensionError;

pub type ListThingModelVersionsRequest =
    rpc_command::invoker::Request<ListThingModelVersionsInputArguments>;
pub type ListThingModelVersionsResponse =
    rpc_command::invoker::Response<ListThingModelVersionsOutputArguments>;
pub type ListThingModelVersionsResponseError =
    rpc_command::invoker::Response<ThingModelExtensionError>;
pub type ListThingModelVersionsRequestBuilderError = rpc_command::invoker::RequestBuilderError;

#[derive(Default)]
/// Builder for [`ListThingModelVersionsRequest`]
pub struct ListThingModelVersionsRequestBuilder {
    inner_builder: rpc_command::invoker::RequestBuilder<ListThingModelVersionsInputArguments>,
    topic_tokens: HashMap<String, String>,
}

impl ListThingModelVersionsRequestBuilder {
    ...
    pub fn payload(
        &mut self,
        payload: ListThingModelVersionsInputArguments,
    ) -> Result<&mut Self, AIOProtocolError> {
        self.inner_builder.payload(payload)?;
        Ok(self)
    }

    /// Builds a new `ListThingModelVersionsRequest`
    ///
    /// # Errors
    ...
    pub fn build(
        &mut self,
    ) -> Result<ListThingModelVersionsRequest, ListThingModelVersionsRequestBuilderError> {
...
/// Command Invoker for `listThingModelVersions`
pub struct ListThingModelVersionsActionInvoker(
    rpc_command::Invoker<
...
impl ListThingModelVersionsActionInvoker {
    /// Creates a new [`ListThingModelVersionsActionInvoker`]
    ///
    /// # Panics
    ...
    /// Invokes the [`ListThingModelVersionsRequest`]
    ///
    /// # Errors
    /// [`AIOProtocolError`] if there is a failure invoking the request
    pub async fn invoke(
        &self,
        request: ListThingModelVersionsRequest,
    ) -> Result<
        Result<ListThingModelVersionsResponse, ListThingModelVersionsResponseError>,
        AIOProtocolError,
    > {
        ...
        match response {
            Ok(response) => {
                if let Some(error) = response.payload.error {
                    Ok(Err(ListThingModelVersionsResponseError {
                        payload: error,
    ...
    /// Shutdown the [`ListThingModelVersionsActionInvoker`]. Unsubscribes from the response topic and cancels the receiver loop to drop the receiver and to prevent the task from looping indefinitely.
    ///
    ...
    fn get_err(field_name: &str) -> AIOProtocolError {
        AIOProtocolError {
            ...
            property_name: None,
            property_value: None,
            command_name: Some("listThingModelVersions".to_string()),
