...
#[derive(Default)]
/// Builder for [`DeleteSchemaVersionRequest`]
pub struct DeleteSchemaVersionRequestBuilder {
    inner_builder: rpc_command::invoker::RequestBuilder<DeleteSchemaVersionInputArguments>,
    topic_tokens: HashMap<String, String>,
}

impl DeleteSchemaVersionRequestBuilder {
    ...
    pub fn payload(
        &mut self,
        payload: DeleteSchemaVersionInputArguments,
    ) -> Result<&mut Self, AIOProtocolError> {
        self.inner_builder.payload(payload)?;
        Ok(self)
    }

    /// Builds a new `DeleteSchemaVersionRequest`
    ///
    /// # Errors
    ...
    pub fn build(
        &mut self,
    ) -> Result<DeleteSchemaVersionRequest, DeleteSchemaVersionRequestBuilderError> {
...
/// Command Invoker for `deleteSchemaVersion`
pub struct DeleteSchemaVersionActionInvoker(
    rpc_command::Invoker<DeleteSchemaVersionInputArguments, DeleteSchemaVersionResponseSchema>,
);

impl DeleteSchemaVersionActionInvoker {
    /// Creates a new [`DeleteSchemaVersionActionInvoker`]
    ///
    /// # Panics
    ...
    pub fn new(
        ...
        let invoker_options = invoker_options_builder
            .request_topic_pattern("aio/registry/schemaExtension/delete/schemagroups/schemas/{ex:schemaId}/versions/{ex:versionId}")
            .command_name("deleteSchemaVersion")
    ...
    /// Invokes the [`DeleteSchemaVersionRequest`]
    ///
    /// # Errors
    ...
    pub async fn invoke(
        ...
        Result<DeleteSchemaVersionResponse, DeleteSchemaVersionResponseError>,
        AIOProtocolError,
    > {
        ...
        match response {
            Ok(response) => {
                if let Some(error) = response.payload.error {
                    Ok(Err(DeleteSchemaVersionResponseError {
                        payload: error,
    ...
    /// Shutdown the [`DeleteSchemaVersionActionInvoker`]. Unsubscribes from the response topic and cancels the receiver loop to drop the receiver and to prevent the task from looping indefinitely.
    ///
