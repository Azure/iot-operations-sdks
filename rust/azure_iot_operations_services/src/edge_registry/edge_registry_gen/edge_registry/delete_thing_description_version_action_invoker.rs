...
#[derive(Default)]
/// Builder for [`DeleteThingDescriptionVersionRequest`]
pub struct DeleteThingDescriptionVersionRequestBuilder {
    inner_builder:
        rpc_command::invoker::RequestBuilder<DeleteThingDescriptionVersionInputArguments>,
    topic_tokens: HashMap<String, String>,
}

impl DeleteThingDescriptionVersionRequestBuilder {
    ...
    pub fn payload(
        &mut self,
        payload: DeleteThingDescriptionVersionInputArguments,
    ) -> Result<&mut Self, AIOProtocolError> {
        self.inner_builder.payload(payload)?;
        Ok(self)
    }

    /// Builds a new `DeleteThingDescriptionVersionRequest`
    ///
    /// # Errors
    ...
    pub fn build(
        ...
        DeleteThingDescriptionVersionRequest,
        DeleteThingDescriptionVersionRequestBuilderError,
    > {
...
/// Command Invoker for `deleteThingDescriptionVersion`
pub struct DeleteThingDescriptionVersionActionInvoker(
    rpc_command::Invoker<
        DeleteThingDescriptionVersionInputArguments,
        DeleteThingDescriptionVersionResponseSchema,
    >,
);

impl DeleteThingDescriptionVersionActionInvoker {
    /// Creates a new [`DeleteThingDescriptionVersionActionInvoker`]
    ///
    /// # Panics
    ...
    pub fn new(
        ...
        let invoker_options = invoker_options_builder
            .request_topic_pattern("aio/registry/thingDescriptionExtension/delete/thingdescriptiongroups/thingdescriptions/{ex:thingDescriptionId}/versions/{ex:versionId}")
            .command_name("deleteThingDescriptionVersion")
    ...
    /// Invokes the [`DeleteThingDescriptionVersionRequest`]
    ///
    /// # Errors
    /// [`AIOProtocolError`] if there is a failure invoking the request
    pub async fn invoke(
        &self,
        request: DeleteThingDescriptionVersionRequest,
    ) -> Result<
        Result<DeleteThingDescriptionVersionResponse, DeleteThingDescriptionVersionResponseError>,
        AIOProtocolError,
    > {
        ...
        match response {
            Ok(response) => {
                if let Some(error) = response.payload.error {
                    Ok(Err(DeleteThingDescriptionVersionResponseError {
                        payload: error,
    ...
    /// Shutdown the [`DeleteThingDescriptionVersionActionInvoker`]. Unsubscribes from the response topic and cancels the receiver loop to drop the receiver and to prevent the task from looping indefinitely.
    ///
