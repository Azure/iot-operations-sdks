...
use super::create_thing_description_version_input_arguments::CreateThingDescriptionVersionInputArguments;
use super::create_thing_description_version_output_arguments::CreateThingDescriptionVersionOutputArguments;
use super::create_thing_description_version_response_schema::CreateThingDescriptionVersionResponseSchema;
use super::thing_description_extension_error::ThingDescriptionExtensionError;

pub type CreateThingDescriptionVersionRequest =
    rpc_command::invoker::Request<CreateThingDescriptionVersionInputArguments>;
pub type CreateThingDescriptionVersionResponse =
    rpc_command::invoker::Response<CreateThingDescriptionVersionOutputArguments>;
pub type CreateThingDescriptionVersionResponseError =
    rpc_command::invoker::Response<ThingDescriptionExtensionError>;
pub type CreateThingDescriptionVersionRequestBuilderError =
    rpc_command::invoker::RequestBuilderError;

#[derive(Default)]
/// Builder for [`CreateThingDescriptionVersionRequest`]
pub struct CreateThingDescriptionVersionRequestBuilder {
    inner_builder:
        rpc_command::invoker::RequestBuilder<CreateThingDescriptionVersionInputArguments>,
    topic_tokens: HashMap<String, String>,
}

impl CreateThingDescriptionVersionRequestBuilder {
    ...
    pub fn payload(
        &mut self,
        payload: CreateThingDescriptionVersionInputArguments,
    ) -> Result<&mut Self, AIOProtocolError> {
        self.inner_builder.payload(payload)?;
        Ok(self)
    }

    /// Builds a new `CreateThingDescriptionVersionRequest`
    ///
    /// # Errors
    ...
    pub fn build(
        ...
        CreateThingDescriptionVersionRequest,
        CreateThingDescriptionVersionRequestBuilderError,
    > {
...
/// Command Invoker for `createThingDescriptionVersion`
pub struct CreateThingDescriptionVersionActionInvoker(
    rpc_command::Invoker<
...
impl CreateThingDescriptionVersionActionInvoker {
    /// Creates a new [`CreateThingDescriptionVersionActionInvoker`]
    ///
    /// # Panics
    ...
    pub fn new(
        ...
        let invoker_options = invoker_options_builder
            .request_topic_pattern("aio/registry/thingDescriptionExtension/create/thingdescriptiongroups/thingdescriptions/{ex:thingDescriptionId}/versions/version")
    ...
    /// Invokes the [`CreateThingDescriptionVersionRequest`]
    ///
    /// # Errors
    /// [`AIOProtocolError`] if there is a failure invoking the request
    pub async fn invoke(
        &self,
        request: CreateThingDescriptionVersionRequest,
    ) -> Result<
        Result<CreateThingDescriptionVersionResponse, CreateThingDescriptionVersionResponseError>,
        AIOProtocolError,
    > {
        ...
        match response {
            Ok(response) => {
                if let Some(error) = response.payload.error {
                    Ok(Err(CreateThingDescriptionVersionResponseError {
                        payload: error,
                    ...
                    Ok(Ok(CreateThingDescriptionVersionResponse {
                        payload: response.payload.output.ok_or(
                            CreateThingDescriptionVersionActionInvoker::get_err("_output"),
                        )?,
                        content_type: response.content_type,
                        format_indicator: response.format_indicator,
                        custom_user_data: response.custom_user_data,
    ...
    /// Shutdown the [`CreateThingDescriptionVersionActionInvoker`]. Unsubscribes from the response topic and cancels the receiver loop to drop the receiver and to prevent the task from looping indefinitely.
    ///
    ...
    fn get_err(field_name: &str) -> AIOProtocolError {
        AIOProtocolError {
            ...
            property_name: None,
            property_value: None,
            command_name: Some("createThingDescriptionVersion".to_string()),
