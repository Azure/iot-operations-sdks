...
pub struct PutCommandInvoker(rpc_command::Invoker<PutRequestSchema, PutResponseSchema>);

impl PutCommandInvoker {
    ...
    pub fn new(
        ...
        let invoker_options = invoker_options_builder
            .request_topic_pattern("adr/dtmi:ms:adr:SchemaRegistry;2/put")
            .command_name("put")
                    ...
                    Ok(Ok(PutResponse {
                        payload: PutResponsePayload {
                            schema: response
                                .payload
                                .schema
                                .ok_or(PutCommandInvoker::get_err("schema"))?,
                        },
                        content_type: response.content_type,
                        format_indicator: response.format_indicator,
                        custom_user_data: response.custom_user_data,
