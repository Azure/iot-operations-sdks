...
pub struct GetCommandInvoker(rpc_command::Invoker<GetRequestSchema, GetResponseSchema>);

impl GetCommandInvoker {
    ...
    pub fn new(
        ...
        let invoker_options = invoker_options_builder
            .request_topic_pattern("adr/dtmi:ms:adr:SchemaRegistry;2/get")
            .command_name("get")
                    ...
                    Ok(Ok(GetResponse {
                        payload: GetResponsePayload {
                            schema: response
                                .payload
                                .schema
                                .ok_or(GetCommandInvoker::get_err("schema"))?,
                        },
                        content_type: response.content_type,
                        format_indicator: response.format_indicator,
                        custom_user_data: response.custom_user_data,
