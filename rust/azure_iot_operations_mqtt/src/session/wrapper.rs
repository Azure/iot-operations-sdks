...
// use crate::interface::{AckToken, CompletionToken, ManagedClient, MqttPubSub};
...
//         let client_options: azure_mqtt::ClientOptions = options.connection_settings.try_into()?;
//         let connect_properties: azure_mqtt::ConnectProperties = options.connection_settings.try_into()?;
//         let auth_info: Option<azure_mqtt::AuthenticationInfo> = options.connection_settings.try_into()?;
//         let connection_transport_config: azure_mqtt::ConnectionTransportConfig = options.connection_settings.try_into()?;
