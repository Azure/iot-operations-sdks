...
use azure_iot_operations_protocol::telemetry::telemetry_sender::{
    CloudEvent, Message as TelemetryMessageBase, MessageBuilder as TelemetryMessageBuilderBase,
    MessageBuilderError as TelemetryMessageBuilderBaseError,
    OptionsBuilder as TelemetrySenderOptionsBaseBuilder, TelemetrySender as TelemetrySenderBase,
};
