...
namespace Azure.Iot.Operations.UnitTabulator
{
 ...
 foreach (KeyValuePair<string, string> eceCode in this.eceCodesMap) { 
            this.Write("        (\"");
            this.Write(this.ToStringHelper.ToStringWithCulture(eceCode.Key));
            this.Write("\", \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(eceCode.Value));
            this.Write("\"),\r\n");
 } 
            this.Write("    ]));\r\n");
