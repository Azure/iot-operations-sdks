...
namespace Azure.Iot.Operations.EnvoyGenerator
{
 ...
 if (this.generateProject) { 
            ...
            this.Write("# Dependencies for the Generated Libraries\r\n\r\nAdd these dependencies to your proj" +
...
");
 if (this.sdkPath != null) { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(this.IfLocal("path", "git")));
            this.Write(" = \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.sdkPath));
            this.Write(this.ToStringHelper.ToStringWithCulture(this.IfLocal("/azure_iot_operations_mqtt")));
            ...
            this.Write("azure_iot_operations_mqtt = { version = \"1.0\" }\r\nazure_iot" +
                    "_operations_protocol = { version = \"1.0\" }\r\n");
 } 
 if (!this.generateProject) { 
            this.Write("```\r\n");
 } 
