...
$gen --things conv/CommandComplexSchemas.TM.json --outDir rust/command_complex_schemas_gen --lang rust --namespace command_complex_schemas --sdkPath ../../rust
...
$gen --things conv/CommandRaw.TM.json --outDir rust/command_raw_gen --lang rust --namespace command_raw --sdkPath ../../rust
...
$gen --things conv/CommandVariants.TM.json --outDir rust/command_variants_gen --lang rust --namespace command_variants --sdkPath ../../rust
...
$gen --things conv/PropertySeparate.TM.json --outDir rust/property_separate_gen --lang rust --namespace property_separate --sdkPath ../../rust
...
$gen --things conv/PropertyTogether.TM.json --outDir rust/property_together_gen --lang rust --namespace property_together --sdkPath ../../rust
...
$gen --things conv/TelemetryComplexSchemas.TM.json --outDir rust/telemetry_complex_schemas_gen --lang rust --namespace telemetry_complex_schemas --sdkPath ../../rust
...
$gen --things conv/TelemetryPrimitiveSchemas.TM.json --outDir rust/telemetry_primitive_schemas_gen --lang rust --namespace telemetry_primitive_schemas --sdkPath ../../rust
...
$gen --things conv/TelemetryRawSeparate.TM.json --outDir rust/telemetry_raw_separate_gen --lang rust --namespace telemetry_raw_separate --sdkPath ../../rust
