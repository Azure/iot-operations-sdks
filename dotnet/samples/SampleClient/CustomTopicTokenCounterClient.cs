...
internal class CustomTopicTokenCounterClient : CustomTopicTokens.Client
{
    ...
    {
        base.TelemetryCollectionReceiver.TopicTokenMap.TryAdd("myCustomTopicToken", "SomeCustomTopicStringValue");
        base.ReadCustomTopicTokenCommandInvoker.TopicTokenMap.TryAdd("myCustomTopicToken", "SomeCustomTopicStringValue");
    }
