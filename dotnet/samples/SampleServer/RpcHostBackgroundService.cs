...
public class RpcHostBackgroundService(MqttSessionClient mqttClient, IServiceProvider provider, ILogger<RpcHostBackgroundService> logger, IConfiguration configuration) : BackgroundService
{
    ...
    CustomTopicTokenCounterService? serviceWithCustomTopicTokens;
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        serviceWithCustomTopicTokens = provider.GetService<CustomTopicTokenCounterService>()!;
        ...
        await serviceWithCustomTopicTokens!.StartAsync(null, stoppingToken);
    ...
    protected async ValueTask DisposeAsync()
    {
        ...
        await serviceWithCustomTopicTokens!.DisposeAsync();
    }
}
