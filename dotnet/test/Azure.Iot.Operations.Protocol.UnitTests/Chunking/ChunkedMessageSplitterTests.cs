...
public class ChunkedMessageSplitterTests
{
    ...
    {
        // Arrange
        var options = new ChunkingOptions { StaticOverhead = 100 };
    ...
    public void SplitMessage_VerifyChunkMetadata_IsCorrect()
    {
        ...
        Assert.True(ChunkMetadata.TryParse(firstChunkProperty!.Value, out var firstChunkMetadata));
        ...
        Assert.True(ChunkMetadata.TryParse(secondChunkProperty!.Value, out var secondChunkMetadata));
    ...
    public void Integration_SplitAndReassemble_RecoversOriginalMessage()
    {
        ...
        foreach (var chunk in chunks)
        {
            ...
            Assert.True(ChunkMetadata.TryParse(chunkProperty.Value, out var chunkMetadata));
