...
public class MemMonEnvoyTests
{
    ...
    public async Task Send_ReceiveTelemetryWithMetadataAndCE()
    {
        ...
        var MemoryStatsTelemetryMetadata = new OutgoingTelemetryMetadata() { CloudEvent = new ProtocolCloudEvent(new Uri("test://mq")) };
        ...
        var ManagedMemoryTelemetryMetadata = new OutgoingTelemetryMetadata() { CloudEvent = new ProtocolCloudEvent(new Uri("test://mq")) };
