...
//    {
//        await using MqttSessionClient _mqttClient = await ClientFactory.CreateAndConnectClientAsyncFromEnvAsync("test");
//        await using DiscoveredAssetResourcesClient mrpcClient = new(_mqttClient);
//        CreateDiscoveredAssetCommandRequest request = new CreateDiscoveredAssetCommandRequest
//        {
...
//        CreateDiscoveredAssetCommandRequest dReq = new CreateDiscoveredAssetCommandRequest
//        {
...
//        CreateDiscoveredAssetEndpointProfileCommandRequest dReq = new CreateDiscoveredAssetEndpointProfileCommandRequest
//        {
