...
namespace Azure.Iot.Operations.Protocol.MetlTests
{
    public class TelemetryReceiverTester
    {
        ...
        {
            public ReceivedTelemetry(string telemetryValue, Dictionary<string, string> metadata, Dictionary<string, string> topicTokens, ProtocolCloudEvent? cloudEvent, string sourceId)
            {
