...
# ls -l /tmp/Azure.Iot.Operations.Services.Akri.Akri
...
# ../../../../codegen/src/Azure.Iot.Operations.ProtocolCompiler/bin/Debug/net8.0/Azure.Iot.Operations.ProtocolCompiler --modelFile discovered_resources_commands_v1.json --outDir ./dtmi_com_microsoft_deviceregistry_DiscoveredAssetResources__1 --lang csharp 
# --sdkPath ../../../../dotnet/src/Azure.Iot.Operations.Protocol