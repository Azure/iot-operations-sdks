...
internal static class ModelsConverter
{
    ...
    internal static GetDeviceResponsePayload ToModel(this AdrBaseService.GetDeviceResponsePayload source)
    {
        return new()
        {
            Device = source.Device.ToModel(),
        };
    }

    internal static GetAssetResponsePayload ToModel(this AdrBaseService.GetAssetResponsePayload source)
    {
        return new()
        {
            Asset = source.Asset.ToModel(),
        };
    }
    ...
    internal static DiscoveredAssetResponse ToModel(this AdrBaseService.DiscoveredAssetResponseSchema source)
    {
        return new()
        {
    ...
    internal static DiscoveredDeviceResponse ToModel(this DeviceDiscoveryService.DiscoveredDeviceResponseSchema source)
    {
        return new()
        {
            DiscoveryId = source.DiscoveryId,
    ...
    internal static UpdateAssetStatusResponsePayload ToModel(this AdrBaseService.UpdateAssetStatusResponsePayload source)
    {
        return new()
        {
            UpdatedAssetStatus = source.UpdatedAssetStatus.ToModel(),
        };
    }

    internal static UpdateDeviceStatusResponsePayload ToModel(this AdrBaseService.UpdateDeviceStatusResponsePayload source)
    {
        return new()
        {
            UpdatedDeviceStatus = source.UpdatedDeviceStatus.ToModel(),
        };
    }

    internal static Device ToModel(this AdrBaseService.Device source)
    {
        return new Device
        {
    ...
    internal static DeviceEndpoints ToModel(this DeviceEndpointsSchema source)
    {
        ...
        {
            Inbound = new Dictionary<string, InboundSchemaMapValue>(
                source.Inbound?.Select(x => new KeyValuePair<string, InboundSchemaMapValue>(x.Key, x.Value.ToModel())) ??
                new Dictionary<string, InboundSchemaMapValue>()),
            Outbound = source.Outbound?.ToModel()
        };
    }

    internal static InboundSchemaMapValue ToModel(this InboundSchemaMapValueSchema source)
    {
        return new InboundSchemaMapValue
        {
