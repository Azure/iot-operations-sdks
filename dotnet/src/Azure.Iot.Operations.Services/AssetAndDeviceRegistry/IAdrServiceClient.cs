...
public interface IAdrServiceClient : IAsyncDisposable
{
    Task<NotificationResponse> ObserveAssetEndpointProfileUpdatesAsync(string aepName,
        Func<string, AssetEndpointProfile?, Task> onAssetEndpointProfileUpdateEventReceived,
        CancellationToken cancellationToken);

    Task<NotificationResponse> UnobserveAssetEndpointProfileUpdatesAsync(string aepName,
        CancellationToken cancellationToken);

    Task<AssetEndpointProfile?> GetAssetEndpointProfileAsync(string aepName,
    ...
    Task<NotificationResponse> ObserveAssetUpdatesAsync(string aepName,
        string assetName,
        Func<string, Asset?, Task> onAssetUpdateEventReceived,
        CancellationToken cancellationToken);

    Task<NotificationResponse> UnobserveAssetUpdatesAsync(string aepName,
        string assetName,
        CancellationToken cancellationToken);
