...
dotnet run --project ../../../../codegen2/src/Azure.Iot.Operations.ProtocolCompiler/ --things ../../../../eng/wot/device-discovery-service/device-discovery-service.json --lang csharp --outDir ./Azure.Iot.Operations.Services.AssetAndDeviceRegistry --noProj --namespace Generated --common Generated.Common --typeNamer ../../../../eng/wot/device-discovery-service/SchemaNames.json
