rm -rf ./StateStoreGen
mkdir ./StateStoreGen
../../../../codegen/src/Akri.Dtdl.Codegen/bin/Debug/net8.0/Akri.Dtdl.Codegen --modelFile ../../../../eng/dtdl/dss.json --lang csharp --outDir /tmp/Azure.Iot.Operations.Services.StateStore.Gen
