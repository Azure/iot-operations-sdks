...
/// <summary>
/// A specific Version of a Thing Description. Self-contained: combines the generic Version fields
/// and the thing-description-specific fields, with integer-typed <see cref="VersionId"/> and
/// <see cref="Ancestor"/>.
/// </summary>
public class ThingDescriptionVersion
{
    ...
    /// <summary>
    /// Indicates whether this Version is the default Version of the owning Thing Description.
    /// </summary>
    ...
    /// <summary>
    /// Identifies the format of the thing description document.
    /// </summary>
    ...
    /// <summary>
    /// When compatibility validation is enabled, indicates whether the server has validated that the Version conforms to the rules defined by its Thing Description's compatibility attribute.
    /// </summary>
    public ValidationStatus? CompatibilityValidated { get; set; }

    /// <summary>
    /// The raw thing description document for this Version.
    /// </summary>
