...
namespace Azure.Iot.Operations.Services.EdgeRegistry.Generated
{
    ...
    public static partial class EdgeRegistrySchemaExtensions
    {
        public abstract partial class Client : IAsyncDisposable
        {
            ...
            /// <param name="cancellationToken">Cancellation token.</param>
            /// <returns>The command response.</returns>
            public RpcCallAsync<EmptyJson> DeleteSchemaVersionAsync(DeleteSchemaVersionInputArguments request, CommandRequestMetadata? requestMetadata = null, Dictionary<string, string>? additionalTopicTokenMap = null, TimeSpan? commandTimeout = default, CancellationToken cancellationToken = default)
            {
                string? clientId = this.mqttClient.ClientId;
                if (string.IsNullOrEmpty(clientId))
                {
                ...
                return new RpcCallAsync<EmptyJson>(this.DeleteSchemaVersionInt(request, metadata, prefixedAdditionalTopicTokenMap, commandTimeout, cancellationToken), metadata.CorrelationId);
            }
            ...
            private async Task<ExtendedResponse<EmptyJson>> DeleteSchemaVersionInt(DeleteSchemaVersionInputArguments request, CommandRequestMetadata? requestMetadata, Dictionary<string, string>? prefixedAdditionalTopicTokenMap, TimeSpan? commandTimeout, CancellationToken cancellationToken)
            {
