...
namespace Azure.Iot.Operations.Services.EdgeRegistry.Generated
{
    ...
    public partial class CreateSchemaVersionAttributes : IJsonOnDeserialized, IJsonOnSerializing
    {
        ...
        /// <summary>
        /// Queryable Key Value pairs to be added to the parent Schema. Labels can be used to store additional metadata about the Schema.
        /// </summary>
        [JsonPropertyName("schemaLabels")]
        [JsonIgnore(Condition = JsonIgnoreCondition.Never)]
        [JsonRequired]
        public List<Label> SchemaLabels { get; set; } = default!;
        ...
        void IJsonOnDeserialized.OnDeserialized()
        {
            ...
            if (SchemaLabels is null)
            {
                throw new ArgumentNullException("schemaLabels field cannot be null");
            }
        }
