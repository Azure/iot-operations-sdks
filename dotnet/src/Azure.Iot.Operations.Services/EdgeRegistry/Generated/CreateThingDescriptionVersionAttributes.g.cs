...
namespace Azure.Iot.Operations.Services.EdgeRegistry.Generated
{
    ...
    public partial class CreateThingDescriptionVersionAttributes : IJsonOnDeserialized, IJsonOnSerializing
    {
        ...
        /// </summary>
        [JsonPropertyName("thingDescriptionLabels")]
        [JsonIgnore(Condition = JsonIgnoreCondition.Never)]
        [JsonRequired]
        public List<Label> ThingDescriptionLabels { get; set; } = default!;
        ...
        void IJsonOnDeserialized.OnDeserialized()
        {
            ...
            if (ThingDescriptionLabels is null)
            {
                throw new ArgumentNullException("thingDescriptionLabels field cannot be null");
            }
        }
