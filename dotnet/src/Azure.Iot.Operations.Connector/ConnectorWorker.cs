...
{
    public abstract class ConnectorWorker : BackgroundService
    {
        ...
        /// <summary>
        /// This abstract method defines what this connector should do with the data retrieved from the asset.
        /// </summary>
        /// <param name="mqttSessionClient">A connected MQTT client that can optionally be used to publish data to the MQTT broker.</param>
        ...
        /// <remarks>
        /// An example implementation of this method may publish the provided payload to the MQTT topic defined in the dataset. Alternatively,
        /// this method may push the data to DSS or invoke an RPC.
        /// </remarks>
        public abstract Task ConnectDataAsync(MqttSessionClient mqttSessionClient, Asset asset, Dataset dataset, byte[] payload, ILogger<ConnectorWorker> logger);
        ...
        private async void SampleDataset(object? status)
        {
            ...
            await ConnectDataAsync(_sessionClient, asset, dataset, serializedPayload, _logger);
        }
    }
}