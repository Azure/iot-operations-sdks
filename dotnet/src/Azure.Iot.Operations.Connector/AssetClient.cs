...
namespace Azure.Iot.Operations.Connector
{
    ...
    public class AssetClient : IDisposable
    {
        ...
        internal AssetClient(IAdrClientWrapper adrClient, string deviceName, string inboundEndpointName, string assetName, ConnectorWorker connector, Device device, Asset asset)
        {
