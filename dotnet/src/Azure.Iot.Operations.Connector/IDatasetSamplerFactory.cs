...
namespace Azure.Iot.Operations.Connector
{
    ...
    public interface IDatasetSamplerFactory
    {
        ...
        IDatasetSampler CreateDatasetSampler(Device device, string inboundEndpointName, Asset asset, AssetDataset dataset, EndpointCredentials? endpointCredentials);
    }
}
