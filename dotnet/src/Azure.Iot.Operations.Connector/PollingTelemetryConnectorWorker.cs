...
namespace Azure.Iot.Operations.Connector
{
    public class PollingTelemetryConnectorWorker : EventDrivenTelemetryConnectorWorker
    {
        ...
        {
            base.OnAssetSampleable += AssetSampleable;
            base.OnAssetNotSampleable += AssetNotSampleable;
        }

        public void AssetNotSampleable(object? sender, AssetUnavailabileEventArgs args)
        {
        ...
        public void AssetSampleable(object? sender, AssetAvailabileEventArgs args)
        {
