...
namespace Azure.Iot.Operations.ProtocolCompiler {
    ...
    public partial class DotNetTelemetrySender : DotNetTelemetrySenderBase {
        ...
        public virtual string TransformText() {
            ...
            this.Write("\r\n{\r\n    using System.Collections.Generic;\r\n    using Azure.Iot.Operations.Protoc" +
                    "ol;\r\n    using Azure.Iot.Operations.Protocol.Telemetry;\r\n    using Azure.Iot.Ope" +
                    "rations.Protocol.Models;\r\n    using ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.projectName));
            ...
            this.Write("\r\n    {\r\n        /// <summary>\r\n        /// Specializes the <c>TelemetrySender</c" +
                    "> class for type <c>");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.schemaType.GetTypeName(TargetLanguage.CSharp)));
            this.Write("</c>.\r\n        /// </summary>\r\n        public class ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.componentName.GetTypeName(TargetLanguage.CSharp)));
            this.Write(" : TelemetrySender<");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.schemaType.GetTypeName(TargetLanguage.CSharp)));
            this.Write(@">
        {
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(this.telemetryName.IsEmpty ? "null" : $"\"{this.telemetryName.AsGiven}\""));
            this.Write(", new ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.serializerClassName));
            this.Write("())\r\n            {\r\n                this.effectiveTopicTokenMap = new(string.Empt" +
                    "y, (IReadOnlyDictionary<string, string>)base.TopicTokenMap, \"ex:\", this.CustomTo" +
 ...
 if (!this.telemetryName.IsEmpty) { 
            this.Write("                base.TopicTokenMap[\"telemetryName\"] = \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.telemetryName.AsGiven));
            this.Write("\";\r\n");
 } 
            this.Write("            }\r\n        }\r\n    }\r\n}\r\n");
