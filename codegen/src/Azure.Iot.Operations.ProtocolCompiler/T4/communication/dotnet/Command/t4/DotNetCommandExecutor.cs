            ...
            this.Write(@"
{
 ...
 if (this.ttl != null) { 
            this.Write("        [CommandBehavior(idempotent: true, cacheTtl: \"");
            ...
            this.Write("        [CommandBehavior(idempotent = false, cacheTtl: \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.ttl));
            this.Write("\")]\r\n");
 } 
            this.Write("        public class ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.commandName.GetTypeName(TargetLanguage.CSharp, "command", "executor")));
