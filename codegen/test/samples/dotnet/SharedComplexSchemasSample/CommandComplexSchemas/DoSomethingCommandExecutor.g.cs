...
namespace SharedComplexSchemasSample.CommandComplexSchemas
{
    ...
    {
        /// <summary>
        /// Specializes a <c>CommandExecutor</c> class for Command 'doSomething'.
        /// </summary>
        public class DoSomethingCommandExecutor : CommandExecutor<DoSomethingRequestPayload, SomeResponseInfo>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DoSomethingCommandExecutor"/> class.
            /// </summary>
            public DoSomethingCommandExecutor(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "doSomething", new Utf8JsonSerializer())
            {
                this.effectiveTopicTokenMap = new(string.Empty, (IReadOnlyDictionary<string, string>)base.TopicTokenMap, "ex:", this.CustomTopicTokenMap);

                base.TopicTokenMap["modelId"] = "dtmi:jsonTest:CommandComplexSchemas;1";
                if (mqttClient.ClientId != null)
                {
                    base.TopicTokenMap["executorId"] = mqttClient.ClientId;
                }
                base.TopicTokenMap["commandName"] = "doSomething";
            }
        }
    }
}
