...
namespace AvroComm.AvroModel
{
    ...
    public class ScheduleSchemaBase
    {
        public virtual Schema Schema { get => Schema.Parse(@"{""namespace"":""AvroComm.AvroModel"",""name"":""ScheduleSchema"",""type"":""record"",""fields"":[]}"); }
    }

    [System.CodeDom.Compiler.GeneratedCode("Azure.Iot.Operations.ProtocolCompiler", "0.6.0.0")]
    public partial class ScheduleSchema : ScheduleSchemaBase, ISpecificRecord
    {
