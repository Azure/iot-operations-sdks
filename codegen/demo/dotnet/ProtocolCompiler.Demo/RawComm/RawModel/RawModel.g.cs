...
namespace RawComm.RawModel
{
    ...
    public static partial class RawModel
    {
        public abstract partial class Service : IAsyncDisposable
        {
            ...
            public async Task SendTelemetryAsync(byte[] telemetry, OutgoingTelemetryMetadata metadata, MqttQualityOfServiceLevel qos = MqttQualityOfServiceLevel.AtLeastOnce, TimeSpan? messageExpiryInterval = null, CancellationToken cancellationToken = default)
            {
        ...
        public abstract partial class Client
        {
            ...
            public abstract Task ReceiveTelemetry(string senderId, byte[] telemetry, IncomingTelemetryMetadata metadata);
