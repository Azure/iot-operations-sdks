...
namespace RawComm.RawModel
{
    ...
    {
        /// <summary>
        /// Specializes the <c>TelemetryReceiver</c> class for type <c>byte[]</c>.
        /// </summary>
        public class TelemetryReceiver : TelemetryReceiver<byte[]>
        {
            ...
            public TelemetryReceiver(IMqttPubSubClient mqttClient)
                : base(mqttClient, null, new PassthroughSerializer())
            {
                this.effectiveTopicTokenMap = new(string.Empty, (IReadOnlyDictionary<string, string>)base.TopicTokenMap, "ex:", this.CustomTopicTokenMap);

                base.TopicTokenMap["modelId"] = "dtmi:codegen:communicationTest:rawModel;1";
            }
        }
    }
}
