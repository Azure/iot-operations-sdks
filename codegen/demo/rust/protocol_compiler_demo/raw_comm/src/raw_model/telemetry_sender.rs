...
pub type TelemetryMessage = TelemetryMessageBase<Bytes>;
...
pub struct TelemetryMessageBuilder {
    inner_builder: TelemetryMessageBuilderBase<Bytes>,
}
...
impl TelemetryMessageBuilder {
    ...
    pub fn payload(&mut self, payload: Bytes) -> Result<&mut Self, AIOProtocolError> {
...
/// Telemetry Sender for `Bytes`
pub struct TelemetrySender<C>(TelemetrySenderBase<Bytes, C>)
where
    ...
    C: ManagedClient + Send + Sync + 'static,
{
    ...
    pub fn new(client: C, options: &TelemetryOptions) -> Self {
        ...
        Self(
            TelemetrySenderBase::new(client, sender_options)
                .expect("DTDL schema generated invalid arguments"),
        )
    }
