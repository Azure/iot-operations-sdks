namespace Azure.Iot.Operations.EnvoyGenerator
{
    ...
    public partial class RustCargoToml : IEnvoyTemplateTransform
    {
        ...
        public RustCargoToml(string projectName, List<SerializationFormat> genFormats, string? sdkPath, bool generateProject)
        {
        ...
        public string FolderPath { get => this.generateProject ? string.Empty : "src"; }
    }
}
