...
namespace Azure.Iot.Operations.EnvoyGenerator
{
    ...
    public partial class RustAggregateError : RustAggregateErrorBase
    {
        /// <summary>
 ...
 foreach (var innerNameSchema in this.innerNameSchemas) { 
            this.Write("\r\n        if let Some(");
            this.Write(this.ToStringHelper.ToStringWithCulture(innerNameSchema.Item1.GetFieldName(TargetLanguage.Rust)));
            this.Write(") = &self.");
            this.Write(this.ToStringHelper.ToStringWithCulture(innerNameSchema.Item1.GetFieldName(TargetLanguage.Rust)));
            this.Write(" {\r\n            if err_count == 0 {\r\n                return write!(f, \"{");
            this.Write(this.ToStringHelper.ToStringWithCulture(innerNameSchema.Item1.GetFieldName(TargetLanguage.Rust)));
...
impl Error for ");
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "18.0.0.0")]
    public class RustAggregateErrorBase
    {
        #region Fields
