namespace Azure.Iot.Operations.EnvoyGenerator
{
    ...
    public partial class DotNetTelemetrySender : IEnvoyTemplateTransform
    {
        ...
        public DotNetTelemetrySender(CodeName telemetryName, string projectName, CodeName genNamespace, string modelId, CodeName serviceName, string serializerSubNamespace, string serializerClassName, EmptyTypeName serializerEmptyType, ITypeName schemaType, string topicPattern)
        {
