namespace Azure.Iot.Operations.EnvoyGenerator
{
    ...
    public partial class DotNetTelemetryReceiver : IEnvoyTemplateTransform
    {
        ...
        public DotNetTelemetryReceiver(CodeName telemetryName, string projectName, CodeName genNamespace, string modelId, CodeName serviceName, string serializerSubNamespace, string serializerClassName, EmptyTypeName serializerEmptyType, ITypeName schemaType, string? serviceGroupId, string topicPattern)
        {
