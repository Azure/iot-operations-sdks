...
namespace Azure.Iot.Operations.Opc2WotLib
{
    ...
    public partial class WotAction : WotActionBase
    {
        /// <summary>
 ...
 if (this.inputSchema != null) { 
            this.Write("  \"input\": {\r\n");
 this.PushIndent("    "); 
            this.Write(this.ToStringHelper.ToStringWithCulture(this.inputSchema.TransformText()));
            this.Write("\r\n");
 this.PopIndent(); 
            this.Write("  },\r\n");
 } 
 if (this.outputSchema != null) { 
            this.Write("  \"output\": {\r\n");
 this.PushIndent("    "); 
            this.Write(this.ToStringHelper.ToStringWithCulture(this.outputSchema.TransformText()));
            this.Write("\r\n");
 this.PopIndent(); 
            this.Write("  },\r\n");
 } 
