...
namespace Azure.Iot.Operations.TypeGenerator
{
 ...
 if (referencedSchema.Namespace.Equals(this.objectType.Namespace)) { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(referencedSchema.Namespace.GetFolderName(TargetLanguage.Rust)));
            this.Write("::");
            this.Write(this.ToStringHelper.ToStringWithCulture(referencedSchema.SchemaName.GetFileName(TargetLanguage.Rust)));
            this.Write("::");
            this.Write(this.ToStringHelper.ToStringWithCulture(referencedSchema.SchemaName.GetTypeName(TargetLanguage.Rust)));
            ...
            this.Write("use super::super::common_types::{b64::Bytes, date_only::Date, decimal::Decimal, t" +
                    "ime_only::Time};\r\n\r\n");
 ...
 if (this.allowSkipping) { 
            ...
            this.Write(": ");
            this.Write(this.ToStringHelper.ToStringWithCulture(RustSchemaSupport.GetType(fieldInfo.Value.SchemaType, fieldInfo.Value.IsIndirect, fieldInfo.Value.IsRequired)));
            this.Write(",\r\n");
 firstField = false; } 
            this.Write("}\r\n");
