...
namespace Azure.Iot.Operations.TypeGenerator
{
 ...
 if (fieldInfo.Value.IsRequired) { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(fieldInfo.Value.SchemaType.OrNull ? "" : "!"));
            this.Write(";\r\n\r\n");
 } 
 if (this.serFormat == SerializationFormat.Json && this.needsNullCheck) { 
            this.Write("        void IJsonOnDeserialized.OnDeserialized()\r\n        {\r\n");
 foreach (var fieldInfo in this.objectType.FieldInfos) { 
 if (!fieldInfo.Value.SchemaType.OrNull && DotNetSchemaSupport.IsNullable(fieldInfo.Value.SchemaType)) { 
            this.Write("            if (");
            this.Write(this.ToStringHelper.ToStringWithCulture(fieldInfo.Key.GetFieldName(TargetLanguage.CSharp)));
