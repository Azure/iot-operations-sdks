...
namespace Azure.Iot.Operations.TypeGenerator
{
 ...
 if (this.enumType.SchemaName.AsGiven.All(c => char.IsLower(c))) { 
            this.Write("\r\n#pragma warning disable CS8981 // The type name \'");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.enumType.SchemaName.AsGiven));
            this.Write("\' only contains lower-cased ascii characters.\r\n");
 } 
            this.Write("\r\nnamespace ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.projectName));
            this.Write(".");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.enumType.Namespace.GetTypeName(TargetLanguage.CSharp)));
            this.Write("\r\n{\r\n");
