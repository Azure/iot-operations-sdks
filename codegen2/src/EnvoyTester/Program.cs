    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (KeyValuePair<string, string> modelNameAndText in modelTextsByName)
            {
                ...
                foreach (GeneratedItem genEnvoy in EnvoyGenerator.GenerateEnvoys(new List<ParsedThing> { new ParsedThing(thing, schemaNamer) }, serializationFormats, targetLanguage, "Namespace", projectName, sdkPath, typeFileNames, srcSubdir, true, true, true))
                {
