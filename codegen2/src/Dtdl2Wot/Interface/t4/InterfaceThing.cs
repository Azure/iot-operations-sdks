...
namespace Dtdl2Wot
{
 ...
 int ix2 = 1; foreach (DTEnumValueInfo enumValue in namespacedEnum.Value.EnumValues) { 
            ...
            this.Write("\": ");
            this.Write(this.ToStringHelper.ToStringWithCulture((ThingDescriber.GetPrimitiveType(namespacedEnum.Value.ValueSchema.Id) == "integer") ? enumValue.EnumValue : $"\"{enumValue.EnumValue}\""));
