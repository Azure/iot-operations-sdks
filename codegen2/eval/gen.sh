...
$gen --things wot/CommandComplexSchemas.TM.json --outDir rust/command_complex_schemas_gen --lang rust --namespace CommandComplexSchemas --sdkPath ../../rust
...
$gen --things wot/CommandVariants.TM.json --outDir rust/command_variants_gen --lang rust --namespace CommandVariants --sdkPath ../../rust
...
$gen --things wot/CounterCollection.TM.json --outDir rust/counters --lang rust --namespace CounterCollection --sdkPath ../../rust
...
$gen --things wot/TelemetryComplexSchemas.TM.json --outDir rust/telemetry_complex_schemas_gen --lang rust --namespace TelemetryComplexSchemas --sdkPath ../../rust
...
$gen --things wot/TelemetryPrimitiveSchemas.TM.json --outDir rust/telemetry_primitive_schemas_gen --lang rust --namespace TelemetryPrimitiveSchemas --sdkPath ../../rust
...
$gen --things wot/PropertySeparate.TM.json --outDir rust/property_separate_gen --lang rust --namespace PropertySeparate --sdkPath ../../rust
...
$gen --things wot/PropertyTogether.TM.json --outDir rust/property_together_gen --lang rust --namespace PropertyTogether --sdkPath ../../rust
...
$gen --things wot/TwoThings.TM.json --outDir rust/two_things_gen --lang rust --namespace TwoThings --sdkPath ../../rust
...
$gen --things wot/ExternalSchemas.TM.json --schemas wot/ExternalSchemas/*.json --outDir rust/external_schemas_gen --lang rust --namespace ExternalSchemas --sdkPath ../../rust
