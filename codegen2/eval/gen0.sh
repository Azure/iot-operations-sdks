...
$gen --thingFiles conv/CommandComplexSchemas.TD.json --outDir rust/command_complex_schemas_gen --lang rust --namespace CommandComplexSchemas --sdkPath ../../rust --srcSubdir src
...
$gen --thingFiles conv/CommandRaw.TD.json --outDir rust/command_raw_gen --lang rust --namespace CommandRaw --sdkPath ../../rust --srcSubdir src
...
$gen --thingFiles conv/CommandVariants.TD.json --outDir rust/command_variants_gen --lang rust --namespace CommandVariants --sdkPath ../../rust --srcSubdir src
...
$gen --thingFiles conv/PropertySeparate.TD.json --outDir rust/property_separate_gen --lang rust --namespace PropertySeparate --sdkPath ../../rust --srcSubdir src
...
$gen --thingFiles conv/PropertyTogether.TD.json --outDir rust/property_together_gen --lang rust --namespace PropertyTogether --sdkPath ../../rust --srcSubdir src
...
$gen --thingFiles conv/TelemetryAndCommand.TD.json --outDir rust/telemetry_and_command_gen --lang rust --namespace TelemetryAndCommand --sdkPath ../../rust --srcSubdir src
...
$gen --thingFiles conv/TelemetryComplexSchemas.TD.json --outDir rust/telemetry_complex_schemas_gen --lang rust --namespace TelemetryComplexSchemas --sdkPath ../../rust --srcSubdir src
...
$gen --thingFiles conv/TelemetryPrimitiveSchemas.TD.json --outDir rust/telemetry_primitive_schemas_gen --lang rust --namespace TelemetryPrimitiveSchemas --sdkPath ../../rust --srcSubdir src
...
$gen --thingFiles conv/TelemetryRawSeparate.TD.json --outDir rust/telemetry_raw_separate_gen --lang rust --namespace TelemetryRawSeparate --sdkPath ../../rust --srcSubdir src
