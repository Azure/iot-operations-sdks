...
$genFromWot --things ./eng/dtdl/AdrBaseService.TM.json --outDir ./eng/dtdl/FromWot/AssetAndDeviceRegistry/adr_base_gen --lang rust --namespace AdrBaseService --workingDir target/akri/AdrBaseService --sdkPath ../../../rust
$genFromWot --things ./eng/dtdl/DeviceDiscoveryService.TM.json --outDir ./eng/dtdl/FromWot/AssetAndDeviceRegistry/device_discovery_gen --lang rust --namespace DeviceDiscoveryService --workingDir target/akri/DeviceDiscoveryService --sdkPath ../../../rust
...
$genFromWot --things ./eng/dtdl/SchemaRegistry.TM.json --outDir ./eng/dtdl/FromWot/SchemaRegistry/schemaregistry_gen --lang rust --namespace SchemaRegistry --workingDir target/akri/SchemaRegistry --sdkPath ../../../rust
...
$genFromWot --things ./eng/dtdl/StateStore.TM.json --outDir ./eng/dtdl/FromWot/StateStore/state_store_gen --lang rust --namespace StateStore --workingDir obj/akri/StateStore --sdkPath ../../../dotnet/src/Azure.Iot.Operations.Protocol
