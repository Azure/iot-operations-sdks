...
| `{senderId}` | Identifier of the asset that that sends Telemetry, by default the MQTT client ID of the asset | required in Protocol Version 1.X; optional otherwise |
