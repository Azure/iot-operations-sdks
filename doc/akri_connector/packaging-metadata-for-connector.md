...
where: 
 ...
 - The connector metadata file is a JSON file that adheres to the schema defined [here](https://json.schemastore.org/aio-connector-metadata-11.0-preview.json) such as the examples in this folder.
